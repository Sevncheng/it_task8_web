			...
			<div class="container ">
	    		...
	    		<div class="row features">
	        		...
	        		<div class="col-xs-3 main-two-end main-media">
	        			<div class="main-fire">
	        				<img src="${pageContext.request.contextPath}/image/home/main-fire.png" height="13">${nub2}
	        			</div>
						<div class="tip-end">累计在线学习人数</div>
						<div class="main-fire-bottom">
							<img src="${pageContext.request.contextPath}/image/home/main-fire.png" height="13">${nub1}
	        			</div>
